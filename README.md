...
1. Máy điều khiển mở `/admin`, nhập `ADMIN_PASSWORD`.
   Dùng nút biểu tượng bút để mở **Câu hỏi & đáp án**. Mỗi câu có thể là chữ hoặc âm thanh tự chạy; Tăng Tốc và Về Đích có lựa chọn **Chỉ có câu hỏi** hoặc **Có ảnh/video** 16:9. Chọn “Chỉ có câu hỏi” cũng xóa media cũ khỏi câu đó. Vượt Chướng Ngại Vật có **4 bộ game độc lập**, mỗi bộ có 6 hàng ngang, đáp án trung tâm, ảnh chướng ngại vật và video kết thúc riêng. Video kết thúc Khởi Động cũng được tải tại đây. Bấm **Lưu & đồng bộ** để ghi bền vững vào `game_content` (không mất khi reload/reset). Nút **Đ** sửa điểm; nút **↺** reset tiến trình nhưng giữ nguyên ngân hàng câu hỏi.
